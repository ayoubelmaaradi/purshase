...
public class SecurityTest {
    ...
    @Before
    public void init() {
        Customer customer = new Customer(anyString(), anyString(), anyString(), anyString(), anyString());
        when(customerRepository.findById(1L)).thenReturn((Optional<Customer>) Optional.of(customer));
    }
